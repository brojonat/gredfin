...
SELECT r.realtor_id, name, company, rp.realtor_id, rp.property_id, rp.listing_id, p.property_id, p.listing_id, price, url, zipcode, city, state, location, last_scrape_ts, last_scrape_status, last_scrape_checksums
FROM realtor r
